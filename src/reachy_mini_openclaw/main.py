...
Examples:
    ...
    parser.add_argument("--gradio", action="store_true", help="Launch Gradio web UI instead of console mode")
    parser.add_argument("--robot-name", type=str, help="Robot name for connection (default: auto-discover)")
    parser.add_argument(
        "--gateway-url",
        type=str,
    ...
    parser.add_argument("--no-openclaw", action="store_true", help="Disable OpenClaw integration")
    parser.add_argument("--no-face-tracking", action="store_true", help="Disable face tracking")
    parser.add_argument("--local-vision", action="store_true", help="Enable local vision processing with SmolVLM2")
    parser.add_argument("--profile", type=str, help="Custom personality profile to use")
